...
>
      <v-navigation-drawer permanent :width="width" :style="{ 'background-color': background }">
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title>
             <v-icon>mdi-map-marker</v-icon>{{stationInfo.name}} 
            </v-list-item-title>
            <v-list-item-subtitle class="datetime">
              pomiar: {{getLocalTime}}
            <div v-show='CheckWeatherHazards(measurement.ta.value,measurement.ra.value,measurement.ws.value)'> <v-icon color="red">warning</v-icon>{{hazardDescription}}</div>
      ...
      <v-list-item >
        <v-list-item-icon >
          <v-icon style="font-size: 24px;">wi wi-thermometer</v-icon>
        </v-list-item-icon>
          <v-list-item-content v-bind="setHistTime(utc)">
            <v-list-item-title style="font-size: 24px; color: rgba(0,0,0,.54);">{{measurement.ta.value}}&deg;C <v-icon style="font-size: 24px; padding-left: 3%">{{WeatherIcon}} </v-icon><v-icon style="font-size: 24px;">{{WeatherArray}} </v-icon></v-list-item-title>
          </v-list-item-content>
      </v-list-item>
    <v-list-item>
      <v-list-item-icon>
    ...
    <v-list-item>
      ...
      <v-list-item-subtitle>{{measurement.r1.value}}mm/h</v-list-item-subtitle>
    </v-list-item>
    <v-list-item v-if='fetchMeasurements'>
      <v-list-item-icon>
